// Lifted from apps/ios-native/Sources/AgenticNativeIOS/AgenticWalletModels.swift
// (Phase 0.5). Kept in lockstep with that file; long term we collapse to one
// shared module once apps/ios-native imports from this package.
import Foundation
