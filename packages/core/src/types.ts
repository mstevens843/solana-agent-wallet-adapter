...
export interface SigningResult {
  signature: string;
  txid?: string;
  // For wallets that don't implement MWA sign_messages reliably, the Android
  // backend substitutes a memo-only legacy transaction containing the proof
  // envelope and signs THAT instead. The signed transaction is never broadcast.
