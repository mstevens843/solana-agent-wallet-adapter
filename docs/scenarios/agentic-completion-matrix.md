...
| Close a Meteora position without pool or position. | Meteora enabled | meteora_close_position | needs_input | question asks for pool and position | no close action prepared | 04 eval harness | meteora-close-needs-position | docs/smoke/agentic-connectors.md |
...
| Close my Meteora DLMM position without identifying it. | Meteora enabled | meteora_close_position | needs_input | question asks for pool and position | no close action prepared | 04 eval harness | needs-input-meteora-close-position | docs/smoke/agentic-connectors.md |
