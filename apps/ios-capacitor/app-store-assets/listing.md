...
- Screenshots (Fastlane-generated into `screenshots/`):
  ...
  - 6.5" iPhone 11 Pro Max - 1242x2688 (required)
  - 5.5" iPhone 8 Plus - 1242x2208 (required if app was ever submitted to older sizes)
  - 12.9" iPad Pro - 2048x2732 (required if "Designed for iPad" is enabled)

## URLs (App Store Connect required)

- Privacy Policy: `https://agentic-signer.com/privacy`
- Marketing URL: `https://agentic-signer.com`
- Support URL: `https://agentic-signer.com/support`
...
- Encryption export: ITSAppUsesNonExemptEncryption = false (no custom crypto;
  all primitives via platform SSL and standard cryptographic libraries).
