      ...
      options: [
        {
          ...
          fields: [
            ...
            formField('intervalSeconds', 'Repeat every', true, { helperText: 'How often each buy runs, in days, hours, or minutes.' }),
            formDateTimeField('startAt', 'Start at', false, { helperText: 'Optional. Defaults to now.' }),
            formField('minPrice', 'Minimum price', false, { helperText: 'Optional. Only fill at or above this price.' }),
            formField('maxPrice', 'Maximum price', false, { helperText: 'Optional. Only fill at or below this price.' }),
            automationAccepted,
          ],
        },
        {
